    ...
    <div class="container">
        <form id="contact-form" class="form-horizontal" method="POST" action="{{ route('front.contact.post') }}">
            ...
            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                <label for="contact-name" class="col-sm-3 control-label">{{ ucfirst(trans('general.name')) }}</label>
                <div class="col-sm-9">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <label for="contact-email" class="col-sm-3 control-label">{{ ucfirst(trans('general.email')) }}</label>
                <div class="col-sm-9">
            ...
            <div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
                <label for="contact-tel" class="col-sm-3 control-label">{{ ucfirst(trans('general.tel')) }}</label>
                <div class="col-sm-9">
            ...
            <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                <label for="contact-message" class="col-sm-3 control-label">{{ ucfirst(trans('general.message')) }}</label>
                <div class="col-sm-9">
