    ...
    <div class="container">
        <form class="form-horizontal" method="POST" action="{{ route('auth.login.post') }}">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="login-name" class="col-sm-3 control-label">{{ ucfirst(trans('general.name')) }}</label>
                <div class="col-sm-9">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                <label for="login-password" class="col-sm-3 control-label">{{ ucfirst(trans('general.password')) }}</label>
                <div class="col-sm-9">
